...
#define DEGREES_PER_CRANK_ROTATION  (360)

#define TOTAL_PHYSICAL_CRANK_TEETH (TOTAL_CRANK_TEETH - MISSING_CRANK_TEETH)
#define TOTAL_ENGINE_CYCLE_INDEXES (((TOTAL_PHYSICAL_CRANK_TEETH - 1) * 2))
#define ANGLE_BETWEEN_TEETH        ENGINE_ANGLE_S((DEGREES_PER_CRANK_ROTATION / TOTAL_CRANK_TEETH))
