...
#ifndef SRC_MAIN_ENGINEANGLEDECODERS_CRANK12X_3_H_
#define SRC_MAIN_ENGINEANGLEDECODERS_CRANK12X_3_H_

#define TOTAL_CRANK_TEETH             12 
#define MISSING_CRANK_TEETH            3
