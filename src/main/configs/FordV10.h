...
/* Engine Config */
#define ENGINE_CYLINDER_COUNT   	 10
#define CRANKSHAFT_REVS_PER_CYCLE     2                  /* Four stroke */
#define NUM_OF_PRECISON_OUTPUTS		 20                  /* Total number of fuel and ignition channels */
#define INJECTOR_FLOW_RATE          915                  /* Flow rate in cc/min */
#define SECONDARY_INJ_FLOW_RATE       0                  /* secondary injector flow rate */
#define ANTICIPATED_STOICH_AFR      14.7                 /* Pump gas */
...
#define MAX_RPM_CRANKING                  430     /* Max RPM at which the ECU will consider it to be in cranking mode */
#define PRIMARY_SKIP_EDGES                  6
#define PRIMARY_INPUT_TOLLERANCE           85.0   /* Difference allowed in percentage */
#define PRIMARY_INPUT_TOLLERANCE_CRANKING  70.0   /* Difference allowed in percentage */
...
/* Ultimate Limits */
#define RPM_FUEL_DISABLE             8300  /* Max RPM allowed before fuel is cut */
#define RPM_FUEL_REENABLE            8000  /* RPM to re-enable fueling */
#define RPM_IGNITION_DISABLE         8300  /* Max RPM allowed before igntion is cut */
#define RPM_IGNTTION_REENABLE        8000  /* RPM at which to re-enable ignition */
#define MAP_MAX_FUEL_DISABLE        185    /* Max KPA allowed before fuel is cut */
#define MAP_FUEL_RENABLE            180    /* KPA at which to re-enable fueling */
#define MAP_MAX_IGNITION_DISABLE    185    /* Max KPA before igntion is cut */
#define MAP_IGNITION_REENABLE       180    /* KPA to re-enable igntion */

/* First De-rate Limits */
#define DERATE_L1_RPM_FUEL_DISABLE            3000
#define DERATE_L1_RPM_FUEL_REENABLE           2900
#define DERATE_L1_RPM_IGNITION_DISABLE        3000
#define DERATE_L1_RPM_IGNTTION_REENABLE       2900
...
#define ENGINE_CYL_VOLUME		    CC_VOLUME_S(575)
...
#define CYL_1_SECONDARY_INJ_CH      255         /* XGate secondary fuel channel */
...
#define CYL_2_SECONDARY_INJ_CH      255         /* XGate secondary fuel channel */
...
#define CYL_3_PRIMARY_INJ_CH        10          /* XGate primary fuel channel */
#define CYL_3_SECONDARY_INJ_CH      255         /* XGate secondary fuel channel */
...
#define CYL_4_PRIMARY_INJ_CH        11           /* XGate primary fuel channel */
#define CYL_4_SECONDARY_INJ_CH      255          /* XGate secondary fuel channel */

#define CYL_5_TDC_ANGLE             455         /* TDC angle */
#define CYL_5_INJ_ANGLE             180         /* Angle to inject Fuel */
#define CYL_5_READ_ANGLE            90          /* Angle to sample sensors */
#define CYL_5_IGN_CH                4           /* XGate ignition channel  */
#define CYL_5_PRIMARY_INJ_CH        12          /* XGate primary fuel channel */
#define CYL_5_SECONDARY_INJ_CH      255         /* XGate secondary fuel channel */

#define CYL_6_TDC_ANGLE             630         /* TDC angle */
#define CYL_6_INJ_ANGLE             315         /* Angle to inject Fuel */
#define CYL_6_READ_ANGLE            360         /* Angle to sample sensors */
#define CYL_6_IGN_CH                5           /* XGate ignition channel */
#define CYL_6_PRIMARY_INJ_CH        13          /* XGate primary fuel channel */
#define CYL_6_SECONDARY_INJ_CH      255         /* XGate secondary fuel channel */

#define CYL_7_TDC_ANGLE             90          /* TDC angle */
#define CYL_7_INJ_ANGLE             540         /* Angle to inject Fuel */
#define CYL_7_READ_ANGLE            450         /* Angle to sample sensors */
#define CYL_7_IGN_CH                6           /* XGate ignition channel */
#define CYL_7_PRIMARY_INJ_CH        14          /* XGate primary fuel channel */
#define CYL_7_SECONDARY_INJ_CH      255         /* XGate secondary fuel channel */

#define CYL_8_TDC_ANGLE             270         /* TDC angle */
#define CYL_8_INJ_ANGLE             0           /* Angle to inject Fuel */
#define CYL_8_READ_ANGLE            630         /* Angle to sample sensors */
#define CYL_8_IGN_CH                7           /* XGate ignition channel */
#define CYL_8_PRIMARY_INJ_CH        15          /* XGate primary fuel channel */
#define CYL_8_SECONDARY_INJ_CH      255         /* XGate secondary fuel channel */
