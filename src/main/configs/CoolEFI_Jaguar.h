...
/* We reserve the first two channels for ignition */
...
/* We setup the next for channels of Port B for fuel */
...
/* We reserve the next two channels for Stepper IAC Control */ 
...
/* Set of 4 channels for fuel for more than 4 cylinders */
#define CH10_PORT  PORTK_ADDR
#define CH10_MASK  (1 << 0)

#define CH11_PORT  PORTK_ADDR
#define CH11_MASK  (1 << 1)

#define CH12_PORT  PORTK_ADDR
#define CH12_MASK  (1 << 2)

#define CH13_PORT  PORTK_ADDR
#define CH13_MASK  (1 << 3)

/* Six channels used for ignition, for => 2 cylinders COP
 * or for => 4 cylinder wasted spark                      */
...
#define CH18_PORT  PORTA_ADDR
#define CH18_MASK  (1 << 4)

#define CH19_PORT  PORTA_ADDR
#define CH19_MASK  (1 << 5)

/* More channels, incase you need them */
#define CH20_PORT  PORTH_ADDR
#define CH20_MASK  (1 << 0)

#define CH21_PORT  PORTH_ADDR
#define CH21_MASK  (1 << 1)

#define CH22_PORT  PORTH_ADDR
#define CH22_MASK  (1 << 2)

#define CH23_PORT  PORTH_ADDR
#define CH23_MASK  (1 << 3)
