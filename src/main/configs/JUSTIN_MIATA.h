...
#include "../engineAngleDecoders/Cam12x-1-12x-1_Cam1x.h"
...
#define MAP_MAXIMUM                 315.5   /* At 5.0v */
...
#define INPUT_OFFSET			          ENGINE_ANGLE_S(225)
FIXME engine TDC logic has changed
...
#define CYL_1_INJ_ANGLE             0           /* Angle to inject Fuel */
#define CYL_1_READ_ANGLE            0           /* Angle to sample sensors */
...
/* CHT Transfer Table */
#define CHT_TRANSFER_TABLE           "../data/thermistors/Denso-2k2Bias.h"

/* IAT Transfer Table */
#define IAT_TRANSFER_TABLE           "../data/thermistors/GM-2k2Bias.h"

/* FUEL (VE) Table(s) */
#define VE_TABLE_RPM_LENGTH          16
#define VE_TABLE_LOAD_LENGTH         16
#define VE_RPM_AXIS_PRIMARY          "../data/tables/axis/JustinMiata-RPM-16.h"
#define VE_LOAD_AXIS_PRIMARY         "../data/tables/axis/JustinMiata-Load-16.h"
#define VE_TABLE_PRIMARY             "../data/tables/ve/JustinMiata-VE16RPMx16Load.h"
...
#define LAMBDA_RPM_AXIS              "../data/tables/axis/JustinMiata-RPM-16.h"
#define LAMBDA_LOAD_AXIS             "../data/tables/axis/JustinMiata-Load-16.h"
#define LAMBDA_TABLE                 "../data/tables/lambda/JustinMiata-Lambda16RPMx16Load.h"

/* Ignition Table */
#define IGNITION_TABLE_RPM_LENGTH    24
#define IGNITION_TABLE_LOAD_LENGTH   19
#define IGNITION_RPM_AXIS_PRIMARY    "../data/tables/axis/JustinMiata-RPM-24.h"
#define IGNITION_LOAD_AXIS_PRIMARY   "../data/tables/axis/JustinMiata-Load-19.h"
#define IGNITION_TABLE_PRIMARY       "../data/tables/ign/JustinMiata-Timing24RPMx19Load.h"
