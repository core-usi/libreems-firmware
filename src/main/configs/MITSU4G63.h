...
#include "../engineAngleDecoders/MitsiAndMazda-CAS-4and2.h"

// Mitsubishi 4G63 4 cylinder
/* Engine Config */
#define ENGINE_CYLINDER_COUNT		4
#define CRANKSHAFT_REVS_PER_CYCLE	2    /* Four stroke */
#define NUM_OF_PRECISON_OUTPUTS		8    /* Total number of fuel and ignition channels */
#define INJECTOR_FLOW_RATE          240.0   /* Flow rate in cc/min */
...
#define PRIMARY_INPUT_TOLLERANCE           70.0   /* Difference allowed in percentage */
...
#define MAP_MAXIMUM                 250.0  /* At 5.0v */
#define MAP_MINIMUM                 20.0   /* At 0v   */
...
/* Ultimate Limits */
#define RPM_FUEL_DISABLE            7150  /* Max RPM allowed before fuel is cut */
#define RPM_FUEL_REENABLE           7000  /* RPM to re-enable fueling */
#define RPM_IGNITION_DISABLE        7200  /* Max RPM allowed before ignition is cut */
#define RPM_IGNTTION_REENABLE       7100  /* RPM at which to re-enable ignition */
#define MAP_MAX_FUEL_DISABLE        200    /* Max KPA allowed before fuel is cut */
#define MAP_FUEL_RENABLE            180    /* KPA at which to re-enable fueling */
#define MAP_MAX_IGNITION_DISABLE    210    /* Max KPA before ignition is cut */
#define MAP_IGNITION_REENABLE       190    /* KPA to re-enable ignition */
...
#define ENGINE_CYL_VOLUME		      CC_VOLUME_S(475)
...
#define CYL_1_TDC_ANGLE             0           /* TDC angle */
#define CYL_1_INJ_ANGLE             650         /* Angle to inject Fuel */
#define CYL_1_READ_ANGLE            650         /* Angle to sample sensors */
...
#define CYL_2_TDC_ANGLE             540         /* TDC angle */
#define CYL_2_INJ_ANGLE             470         /* Angle to inject Fuel */
#define CYL_2_READ_ANGLE            470         /* Angle to sample sensors */
...
#define CYL_3_TDC_ANGLE             180         /* TDC angle */
#define CYL_3_INJ_ANGLE             110           /* Angle to inject Fuel */
#define CYL_3_READ_ANGLE            110           /* Angle to sample sensors */
...
#define CYL_4_TDC_ANGLE             360         /* TDC angle */
#define CYL_4_INJ_ANGLE             290           /* Angle to inject Fuel */
#define CYL_4_READ_ANGLE            290           /* Angle to sample sensors */
...
/* CHT Transfer Table */
#define CHT_TRANSFER_TABLE           "../data/thermistors/Denso-2k49Bias.h"

/* IAT Transfer Table */
#define IAT_TRANSFER_TABLE           "../data/thermistors/Denso-2k49Bias.h"

/* FUEL (VE) Table(s) */
#define VE_TABLE_RPM_LENGTH          24
#define VE_TABLE_LOAD_LENGTH         19
...
/* Lambda Table */
#define LAMBDA_TABLE_RPM_LENGTH      24
#define LAMBDA_TABLE_LOAD_LENGTH     19
...
/* Ignition Table */
#define IGNITION_TABLE_RPM_LENGTH    24
#define IGNITION_TABLE_LOAD_LENGTH   19
...
#define IGNITION_TABLE_SECONDARY     "../data/tables/ign/flat0degrees.h"
...
#define INJECTION_TABLE_PRIMARY       "../data/tables/ve/Default-VE24RPMx19Load.h"
