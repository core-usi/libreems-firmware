...
//      },
    ...
    .GPIOchannels[5] = { .varPointer = 0, .upperBoundary = 0, .lowerBoundary = 0, .reg = 0, .mask = 0, .flags = {0}},
    .GPIOchannels[6] = { .varPointer = 0, .upperBoundary = 0, .lowerBoundary = 0, .reg = 0, .mask = 0, .flags = {0}},
    .GPIOchannels[7] = { .varPointer = 0, .upperBoundary = 0, .lowerBoundary = 0, .reg = 0, .mask = 0, .flags = {0}},
    .GPIOchannels[8] = { .varPointer = 0, .upperBoundary = 0, .lowerBoundary = 0, .reg = 0, .mask = 0, .flags = {0}},
