...
#define LEGACY_BENCH_TESTS_DEPRECATED         0x7784

#define PATTERN_TEST_ID_INVALID                0x8888
#define PATTERN_TEST_DELAY_TOO_LOW             0x8889
#define PATTERN_TEST_DELAY_TOO_HIGH            0x8890
#define PATTERN_TEST_RUNTIME_TOO_LOW           0x8891
#define PATTERN_TEST_RUNTIME_TOO_HIGH          0x8892
#define PATTERN_TEST_INTERVAL_TOO_LOW          0x8893
#define PATTERN_TEST_INTERVAL_TOO_HIGH         0x8894
#define PATTERN_TEST_NUMBER_OF_EVENTS_TOO_LOW  0x8895
#define PATTERN_TEST_NUMBER_OF_EVENTS_TOO_HIGH 0x8896
