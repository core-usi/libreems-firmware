...
#define INTERFACE_VERSION  "LibreEMS 0.2.0" // Migrate to come from the makefile where it can be extracted from any file with any tool.

// Sizes for array must be outside ifndef block
#ifndef HOST_TESTS
#define INTERFACE_VERSION_LENGTH   sizeof(INTERFACE_VERSION)
#define FIRMWARE_VERSION_LENGTH    sizeof(FIRMWARE_VERSION) + sizeof(BUILD_CONFIG)
...
#else //Hack for cross compilation tests
#define INTERFACE_VERSION_LENGTH   100
#define FIRMWARE_VERSION_LENGTH    100
#define FIRMWARE_BUILD_DATE_LENGTH 100
#define COMPILER_VERSION_LENGTH    100
#define OPERATING_SYSTEM_LENGTH    100
#endif
