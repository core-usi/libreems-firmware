...
/* 2D Structured tables (TablesA/) */
#define VOLTAGE_VS_DWELL_DESIRED_TABLE_LOCATION_ID          0x0100
#define VOLTAGE_VS_DWELL_DESIRED_TABLE2_LOCATION_ID         0x0101
...
#define ENGINE_TEMP_ENRICHMENT_TABLE_LOCATION_ID            0x010A
#define ENGINE_TEMP_ENRICHMENT_TABLE2_LOCATION_ID           0x010B
#define RPM_VS_DWELL_TABLE_LOCATION_ID                      0x010C
#define RPM_VS_DWELL_TABLE2_LOCATION_ID                     0x010D
#define RPM_VS_BLEND_TABLE_LOCATION_ID                      0x010E
#define RPM_VS_BLEND_TABLE2_LOCATION_ID                     0x010F
#define MAF_VS_VOLTAGE_TABLE_LOCATION_ID                    0x011F

#define IAT_VS_IGN_TABLE_LOCATION_ID                        0x0121
#define CLT_VS_IGN_TABLE_LOCATION_ID                        0x0122
#define ETHANOL_PERCENT_VS_IGN_TABLE_LOCATION_ID            0x0123
#define MAP_LUT_LOCATION_ID                                 0x0124
#define AAP_LUT_LOCATION_ID                                 0x0125
#define EGO_LUT_LOCATION_ID                                 0x0126
#define RPM_LIMIT_VS_ENGINE_TEMP_TABLE_LOCATION_ID          0x0127
#define RPM_VS_IAC_STEPS_TABLE_LOCATION_ID                  0x0128
...
/* Fixed configs whole */
#define CONFIG_LOCATION_ID                                  0xA000
