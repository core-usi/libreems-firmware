...
#define UPDATE_BLOCK_IN_RAM              0x0100 /* Self explanatory */
#define UPDATE_BLOCK_IN_FLASH            0x0102 /* Self explanatory */
#define RETRIEVE_BLOCK_FROM_RAM          0x0104 /* Self explanatory */
#define RETRIEVE_BLOCK_FROM_FLASH        0x0106 /* Self explanatory */
#define BURN_BLOCK_FROM_RAM_TO_FLASH     0x0108 /* Self explanatory */

/* Datalog request packets */
#define REQUEST_DATALOG_PACKET           0x0190 /* Manual one-shot datalog for when streaming is turned off */
...
#define REQUEST_JUMP_TO_SERIAL_MONITOR   0x030A  /* Send the CPU to the serial monitor */
#define RETRIEVE_JSON_FIELD_DESCRIPTOR   0x030C  /* Send all field descriptors in JSON format */
#define RETRIEVE_JSON_TABLE_DESCRIPTOR   0x030E  /* Send table descriptors in JSON format */
...
// Bench testing init calls
#define START_PATTERN_TEST_SEQUENCE      0x8890

// Single channel output tests
#define OUTPUT_TEST_SEQUENCE            0x8892

// Data interrogation gold
#define RETRIEVE_LIST_OF_LOCATION_IDS    0xDA5E // Get list of Location ID's
#define RETRIEVE_LOCATION_ID_DETAILS     0xF8E0 // Get details about requested Location ID
