...
const int8_t TD_OILP_SENSOR_LUT[] TD_NAME_PAGE = "Oil Pressure LUT";
...
const int8_t TD_OILP_VS_VOLTAGE_SENSOR_LOOKUP[] TD_DESC_PAGE = "Oil Pressure vs Volts sensor lookup";
